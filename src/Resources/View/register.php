...
<div class="container">
    <div>
        <?php if (isset($_SESSION['is_submited'])): ?>
            <?php if ($_SESSION['is_submited'] === true): ?>
                <h3>Регистрация прошла успешна, данные отправлены на почту</h3>
            <?php else: ?>
                <h3>Произошла ошибка, попробуйте позже</h3>
            <?php endif; ?>
            <?php unset($_SESSION['is_submited']); ?>
        <?php endif; ?>
    </div>
